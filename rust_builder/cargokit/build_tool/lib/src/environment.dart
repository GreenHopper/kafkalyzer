...
class Environment {
  ...
  static String get targetTempDir {
    if (Platform.isWindows) {
      // FIX: Use a very short path on Windows to avoid MAX_PATH issues (MSB3491)
      final shortDir = Directory(r'C:\b\tgt');
      if (!shortDir.existsSync()) {
        shortDir.createSync(recursive: true);
      }
      return shortDir.path;
    }
    return _getEnv("CARGOKIT_TARGET_TEMP_DIR");
  }
